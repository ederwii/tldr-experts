    ...
    expect(
      renderRunLine(
        { modelName: "Sonnet", usedPercentage: 16, totalCostUsd: 3.75 },
        {
          ...
          done: 2, total: 5, ceilingUsd: 25, spentUsd: 3.75, openCount: 1, autoGates: 0, staleStages: 0, source: "run-store",
        },
      ),
  ...
  test("drops the expert segment when the stage has none", () => {
    const line = renderRunLine(
      { modelName: "Opus", usedPercentage: 3.9, totalCostUsd: 0 },
      {
        ...
        done: 0, total: 2, ceilingUsd: 10, spentUsd: 0, openCount: 1, autoGates: 0, staleStages: 0, source: "run-store",
      },
    );
