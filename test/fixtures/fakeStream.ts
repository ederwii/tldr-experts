 ...
 *
 * Shared by all four fake binaries so there is ONE place that knows what
 * `--output-format stream-json` looks like, and so a fake can never drift into
 * emitting a shape the real CLI does not.
 *
