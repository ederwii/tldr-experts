# Build — story S2 — run 260829-build
...
Implement **S2 · Second story** in repo `app`, on branch `story/260829-build/S2`
(cut from `epic/e1`). Your working directory is already the worktree for that branch:

    <ROOT>/.tldrx/worktrees/app/260829-build-S2

Done-when, all of it testable:

- S2 exists and the suite is green

The test plan the Plan phase committed to:

- Unit: the S2 file is written
