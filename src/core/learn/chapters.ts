...
const CHAPTER_4: Chapter = {
  ...
  debrief: [
    ...
    "it opens a PR from the epic branch, with the run's handoff carried whole in the body, so the",
    "reviewer gets the same evidence the gates got. It is the last command of a real run and the",
    "tutorial never needs it, because a sandbox has no remote. On your own repo it is the one you",
    "will type most.",
    "",
