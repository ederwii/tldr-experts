...
export function featureBrief(feature: Feature): string {
  ...
  return [
    ...
    "",
    "  Use it when **Signal** and **Where** are themselves `absent:` and you have looked. It is not a",
    "  shortcut for a query you could not be bothered to work out, and an unsourced `none` is refused",
    "  exactly like an unsourced bullet. Describing a query in prose is still refused either way.",
