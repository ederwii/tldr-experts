...
function reporting(tldr: boolean): readonly string[] {
  ...
  return [
    ...
    "fact that must outlive the turn is `tldrx facts add \"<text>\" --area <id> --decided-by driver`",
    "(an owner-decided fact instead: `--decided-by owner`) — every later prompt DOES read it.",
    "",
