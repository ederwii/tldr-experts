...
import type { IgnoredRow } from "./readEvidenceRows.ts";
...
export interface AreaRecord {
  ...
  /** Rows the file declares that no reader could count — unknown kind, or a `src` that is not a citation of that kind. */
