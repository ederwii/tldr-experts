...
themselves, a usage refusal such as an attended run; the bound; and an attempt whose last line is the previous
attempt's verbatim — a refusal repeating, which one relaunch has already proved and a second would only hammer.
